# This python code has been referred from https://github.com/hoang-tn-nguyen/Disfl-QA-Performer/utils.py
...
def data_to_device(data, device='cpu'):
	if isinstance(data, torch.Tensor):
		...
		raise TypeError('The data must be of either tensor or tuple or list or dict datatype.')
	return data
...
def data_distributor(model, source):
	if isinstance(source, torch.Tensor):
		...
		raise TypeError('The data must be of either tuple or list datatype.')
	return output
